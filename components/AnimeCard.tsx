...
function AnimeCard({anime, index}: Prop) {
  return (
    <MotionDiv variants={variants} initial="hidden" animate="visible" transition={{delay: 1, ease: "easeInOut", duration: index * 0.5}} viewport={{amount: 0}} className="max-w-sm rounded relative w-full">
